...
var init_input_masks = function(elem) {
    $(".input_decimal", elem).autoNumeric(input_decimal_options);
    $(".input_integer", elem).autoNumeric(input_integer_options);
};
...
var reset_input_masks_on_clone = function(newline) {
  $('.input_decimal', newline).each(function(){
    $(this).autoNumeric('destroy');
    $(this).autoNumeric('init', input_decimal_options);
  });
  $('.input_integer', newline).each(function(){
    $(this).autoNumeric('destroy');
